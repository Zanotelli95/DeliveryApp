package com.example.delivery.activities.products.detail
...
class ClientProductDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewName = findViewById(R.id.textView_nameDetail)
        textViewDescription = findViewById(R.id.textView_descriptionDetail)
...
//compara si un producto ya existe en sharedpref y editar su cantidad
