package com.example.delivery.activities.client.payments.installments
...
import com.example.delivery.activities.client.payments.status.ClientPaymentsStatusActivity
import com.example.delivery.models.*
import com.example.delivery.providers.MercadoPagoProvider
import com.example.delivery.providers.PaymentsProvider
import com.example.delivery.utils.SharedPref
import com.google.gson.Gson
import com.google.gson.JsonArray
import com.google.gson.reflect.TypeToken
import com.optic.delivery.models.MercadoPagoInstallments
import com.optic.delivery.models.MercadoPagoPayment
import com.optic.delivery.models.Payer
    ...
    private fun getInstallments() {
        mercadoPagoProvider.getInstallments(firstSixDigits, "$total")?.enqueue(object: Callback<JsonArray> {
            ...
            override fun onFailure(call: Call<JsonArray>, t: Throwable) {
                ...
                Toast.makeText(this@ClientPaymentsInstallmentsActivity, "", Toast.LENGTH_SHORT).show()
            }
